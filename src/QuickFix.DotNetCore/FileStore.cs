...
namespace QuickFix
{
    ...
    public class FileStore : IMessageStore
    {
        ...
        private void open()
        {
            ...
            headerFile_ = new System.IO.StreamWriter(
                new System.IO.FileStream(headerFileName_, System.IO.FileMode.Append));
                //headerFileName_, true);
        }
        ...
        private void ConstructFromFileCache()
        {
            ...
            {
                using (System.IO.FileStream stream = new System.IO.FileStream(headerFileName_, System.IO.FileMode.Create))
            ...
            {
                using (System.IO.FileStream stream = new System.IO.FileStream(seqNumsFileName_, System.IO.FileMode.Create))
                using (System.IO.StreamReader seqNumReader = new System.IO.StreamReader(stream))
                {
        ...
        private void InitializeSessionCreateTime()
        {
            ...
            {
				using (System.IO.FileStream stream = new System.IO.FileStream(sessionFileName_, System.IO.FileMode.Create))   
                using (System.IO.StreamReader reader = new System.IO.StreamReader(stream))
                {
