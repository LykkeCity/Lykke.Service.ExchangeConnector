...
namespace QuickFix
{
    namespace FIX44 
    {
        public class CollateralInquiryAck : Message
        {
            ...
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("BG"));
            }
            ...
            { 
                get 
                {
                    QuickFix.Fields.CollInquiryID val = new QuickFix.Fields.CollInquiryID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.CollInquiryID val) 
            { 
                this.CollInquiryID = val;
            }
            
            public QuickFix.Fields.CollInquiryID Get(QuickFix.Fields.CollInquiryID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.CollInquiryID val) 
            { 
                return IsSetCollInquiryID();
            }
            
            public bool IsSetCollInquiryID() 
            { 
                return IsSetField(Tags.CollInquiryID);
            }
            public QuickFix.Fields.CollInquiryStatus CollInquiryStatus
            { 
                get 
                {
                    QuickFix.Fields.CollInquiryStatus val = new QuickFix.Fields.CollInquiryStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.CollInquiryStatus val) 
            { 
                this.CollInquiryStatus = val;
            }
            
            public QuickFix.Fields.CollInquiryStatus Get(QuickFix.Fields.CollInquiryStatus val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.CollInquiryStatus val) 
            { 
                return IsSetCollInquiryStatus();
            }
            
            public bool IsSetCollInquiryStatus() 
            { 
                return IsSetField(Tags.CollInquiryStatus);
            }
            public QuickFix.Fields.CollInquiryResult CollInquiryResult
            { 
                get 
                {
                    QuickFix.Fields.CollInquiryResult val = new QuickFix.Fields.CollInquiryResult();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.CollInquiryResult val) 
            { 
                this.CollInquiryResult = val;
            }
            
            public QuickFix.Fields.CollInquiryResult Get(QuickFix.Fields.CollInquiryResult val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.CollInquiryResult val) 
            { 
                return IsSetCollInquiryResult();
            }
            
            public bool IsSetCollInquiryResult() 
            { 
                return IsSetField(Tags.CollInquiryResult);
            }
            public QuickFix.Fields.NoCollInquiryQualifier NoCollInquiryQualifier
            { 
                get 
                {
                    QuickFix.Fields.NoCollInquiryQualifier val = new QuickFix.Fields.NoCollInquiryQualifier();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.NoCollInquiryQualifier val) 
            { 
                this.NoCollInquiryQualifier = val;
            }
            
            public QuickFix.Fields.NoCollInquiryQualifier Get(QuickFix.Fields.NoCollInquiryQualifier val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.NoCollInquiryQualifier val) 
            { 
                return IsSetNoCollInquiryQualifier();
            }
            
            public bool IsSetNoCollInquiryQualifier() 
            { 
                return IsSetField(Tags.NoCollInquiryQualifier);
            }
            ...
            public class NoCollInquiryQualifierGroup : Group
            {
                public static int[] fieldOrder = {Tags.CollInquiryQualifier, 0};
            
                public NoCollInquiryQualifierGroup() 
                  :base( Tags.NoCollInquiryQualifier, Tags.CollInquiryQualifier, fieldOrder)
                {
                }
            
                public override Group Clone()
                {
                    var clone = new NoCollInquiryQualifierGroup();
                    clone.CopyStateFrom(this);
                    return clone;
                }
            
                            public QuickFix.Fields.CollInquiryQualifier CollInquiryQualifier
                { 
                    get 
                    {
                        QuickFix.Fields.CollInquiryQualifier val = new QuickFix.Fields.CollInquiryQualifier();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.CollInquiryQualifier val) 
                { 
                    this.CollInquiryQualifier = val;
                }
                
                public QuickFix.Fields.CollInquiryQualifier Get(QuickFix.Fields.CollInquiryQualifier val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.CollInquiryQualifier val) 
                { 
                    return IsSetCollInquiryQualifier();
                }
                
                public bool IsSetCollInquiryQualifier() 
                { 
                    return IsSetField(Tags.CollInquiryQualifier);
                }
