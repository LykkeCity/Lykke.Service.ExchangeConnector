...
namespace QuickFix
{
    namespace FIX44 
    {
        public class CollateralResponse : Message
        {
            ...
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("AZ"));
            }

            public CollateralResponse(
                    QuickFix.Fields.CollRespID aCollRespID,
            ...
            { 
                get 
                {
                    QuickFix.Fields.CollRespID val = new QuickFix.Fields.CollRespID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.CollRespID val) 
            { 
                this.CollRespID = val;
            }
            
            public QuickFix.Fields.CollRespID Get(QuickFix.Fields.CollRespID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.CollRespID val) 
            { 
                return IsSetCollRespID();
            }
            
            public bool IsSetCollRespID() 
            { 
                return IsSetField(Tags.CollRespID);
            }
            ...
            public QuickFix.Fields.CollAsgnRespType CollAsgnRespType
            { 
                get 
                {
                    QuickFix.Fields.CollAsgnRespType val = new QuickFix.Fields.CollAsgnRespType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.CollAsgnRespType val) 
            { 
                this.CollAsgnRespType = val;
            }
            
            public QuickFix.Fields.CollAsgnRespType Get(QuickFix.Fields.CollAsgnRespType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.CollAsgnRespType val) 
            { 
                return IsSetCollAsgnRespType();
            }
            
            public bool IsSetCollAsgnRespType() 
            { 
                return IsSetField(Tags.CollAsgnRespType);
            }
            public QuickFix.Fields.CollAsgnRejectReason CollAsgnRejectReason
            { 
                get 
                {
                    QuickFix.Fields.CollAsgnRejectReason val = new QuickFix.Fields.CollAsgnRejectReason();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.CollAsgnRejectReason val) 
            { 
                this.CollAsgnRejectReason = val;
            }
            
            public QuickFix.Fields.CollAsgnRejectReason Get(QuickFix.Fields.CollAsgnRejectReason val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.CollAsgnRejectReason val) 
            { 
                return IsSetCollAsgnRejectReason();
            }
            
            public bool IsSetCollAsgnRejectReason() 
            { 
                return IsSetField(Tags.CollAsgnRejectReason);
            }
