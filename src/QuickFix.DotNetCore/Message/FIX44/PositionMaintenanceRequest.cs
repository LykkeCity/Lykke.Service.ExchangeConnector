    ...
    namespace FIX44 
    {
        public class PositionMaintenanceRequest : Message
        {
            ...
            { 
                get 
                {
                    QuickFix.Fields.ContraryInstructionIndicator val = new QuickFix.Fields.ContraryInstructionIndicator();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                this.ContraryInstructionIndicator = val;
            }
            ...
            { 
                return IsSetField(Tags.ContraryInstructionIndicator);
            }
            public QuickFix.Fields.PriorSpreadIndicator PriorSpreadIndicator
            { 
                get 
                {
                    QuickFix.Fields.PriorSpreadIndicator val = new QuickFix.Fields.PriorSpreadIndicator();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(Tags.PriorSpreadIndicator);
            }
