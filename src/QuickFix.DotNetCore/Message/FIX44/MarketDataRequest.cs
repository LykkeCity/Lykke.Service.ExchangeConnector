...
namespace QuickFix
{
    namespace FIX44 
    {
        public class MarketDataRequest : Message
        {
            ...
            public QuickFix.Fields.ApplQueueAction ApplQueueAction
            { 
                get 
                {
                    QuickFix.Fields.ApplQueueAction val = new QuickFix.Fields.ApplQueueAction();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.ApplQueueAction val) 
            { 
                this.ApplQueueAction = val;
            }
            
            public QuickFix.Fields.ApplQueueAction Get(QuickFix.Fields.ApplQueueAction val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.ApplQueueAction val) 
            { 
                return IsSetApplQueueAction();
            }
            
            public bool IsSetApplQueueAction() 
            { 
                return IsSetField(Tags.ApplQueueAction);
            }
            public QuickFix.Fields.ApplQueueMax ApplQueueMax
            { 
                get 
                {
                    QuickFix.Fields.ApplQueueMax val = new QuickFix.Fields.ApplQueueMax();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.ApplQueueMax val) 
            { 
                this.ApplQueueMax = val;
            }
            
            public QuickFix.Fields.ApplQueueMax Get(QuickFix.Fields.ApplQueueMax val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.ApplQueueMax val) 
            { 
                return IsSetApplQueueMax();
            }
            
            public bool IsSetApplQueueMax() 
            { 
                return IsSetField(Tags.ApplQueueMax);
            }
            ...
            {
                public static int[] fieldOrder = {Tags.Symbol, Tags.SymbolSfx, Tags.SecurityID, Tags.SecurityIDSource, Tags.NoSecurityAltID, Tags.Product, Tags.CFICode, Tags.SecurityType, Tags.SecuritySubType, Tags.MaturityMonthYear, Tags.MaturityDate, Tags.PutOrCall, Tags.CouponPaymentDate, Tags.IssueDate, Tags.RepoCollateralSecurityType, Tags.RepurchaseTerm, Tags.RepurchaseRate, Tags.Factor, Tags.CreditRating, Tags.InstrRegistry, Tags.CountryOfIssue, Tags.StateOrProvinceOfIssue, Tags.LocaleOfIssue, Tags.RedemptionDate, Tags.StrikePrice, Tags.StrikeCurrency, Tags.OptAttribute, Tags.ContractMultiplier, Tags.CouponRate, Tags.SecurityExchange, Tags.Issuer, Tags.EncodedIssuerLen, Tags.EncodedIssuer, Tags.SecurityDesc, Tags.EncodedSecurityDescLen, Tags.EncodedSecurityDesc, Tags.Pool, Tags.ContractSettlMonth, Tags.CPProgram, Tags.CPRegType, Tags.NoEvents, Tags.DatedDate, Tags.InterestAccrualDate, Tags.NoUnderlyings, Tags.NoLegs, 0};
