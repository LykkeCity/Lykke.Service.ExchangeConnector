    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "ExchangeDataStore API");
                });
                ...
                builder.RegisterModule(new ServiceModule(appSettings.Nested(x => x.ExchangeDataStoreService), Log));
