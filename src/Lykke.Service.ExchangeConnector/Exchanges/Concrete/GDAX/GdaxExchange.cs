...
namespace TradingBot.Exchanges.Concrete.GDAX
{
    internal class GdaxExchange : Exchange
    {
        ...
        public GdaxExchange(GdaxExchangeConfiguration configuration, TranslatedSignalsRepository translatedSignalsRepository,
            GdaxOrderBooksHarvester orderBookHarvester, IHandler<TickPrice> tickPriceHandler, IHandler<ExecutedTrade> tradeHandler, ILog log)
        ...
        {
            await _tradeHandler.Handle(new ExecutedTrade(new Instrument(Name, order.ProductId),
