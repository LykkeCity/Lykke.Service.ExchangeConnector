...
namespace TradingBot.Exchanges.Concrete.Jfd
{
    internal sealed class JfdOrderBooksHarvester : OrderBooksWebSocketHarvester<MarketDataRequest, Message>
    {
        ...
        public JfdOrderBooksHarvester(JfdExchangeConfiguration configuration, JfdModelConverter modelConverter, ILog log, OrderBookSnapshotsRepository orderBookSnapshotsRepository, OrderBookEventsRepository orderBookEventsRepository)
            : base(configuration, new JfdQuotesSessionConnector(configuration, log), log, orderBookSnapshotsRepository, orderBookEventsRepository)
        {
