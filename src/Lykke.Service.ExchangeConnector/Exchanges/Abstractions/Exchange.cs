...
namespace TradingBot.Exchanges.Abstractions
{
    internal abstract class Exchange : IExchange
    {
        ...
        private readonly List<Handler<OrderStatusUpdate>> _executedTradeHandlers = new List<Handler<OrderStatusUpdate>>();

        private readonly List<Handler<OrderStatusUpdate>> _acknowledgementsHandlers = new List<Handler<OrderStatusUpdate>>();
        ...
        public void AddExecutedTradeHandler(Handler<OrderStatusUpdate> handler)
        {
            _executedTradeHandlers.Add(handler);
        }

        public void AddAcknowledgementsHandler(Handler<OrderStatusUpdate> handler)
        {
